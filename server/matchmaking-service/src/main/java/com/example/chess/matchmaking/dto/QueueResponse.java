...
public record QueueResponse(
    ...
    public static QueueResponse matched(UUID gameId, String color, String opponentUsername) {
        return new QueueResponse(Status.MATCHED, gameId, color, opponentUsername);
    }
}
